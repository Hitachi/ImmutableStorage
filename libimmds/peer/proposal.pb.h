...
class SignedProposal PROTOBUF_FINAL :
 ...
 public:
  ...
  "    future release.")
  std::string* unsafe_arena_release_proposal_bytes();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_proposal_bytes(
...
class ChaincodeHeaderExtension PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_payload_visibility();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_payload_visibility(
      std::string* payload_visibility);
  private:
...
public:
  ...
  ChaincodeProposalPayload_TransientMapEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
...
inline void SignedProposal::_internal_set_proposal_bytes(const std::string& value) {
  ...
  proposal_bytes_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void SignedProposal::set_proposal_bytes(const char* value) {
  ...
  proposal_bytes_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void SignedProposal::set_proposal_bytes(const void* value,
  ...
  proposal_bytes_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* SignedProposal::_internal_mutable_proposal_bytes() {
  ...
  return proposal_bytes_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* SignedProposal::unsafe_arena_release_proposal_bytes() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.SignedProposal.proposal_bytes)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return proposal_bytes_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SignedProposal::unsafe_arena_set_allocated_proposal_bytes(
    std::string* proposal_bytes) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (proposal_bytes != nullptr) {
  ...
  proposal_bytes_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      proposal_bytes, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.SignedProposal.proposal_bytes)
}
...
inline std::string* SignedProposal::unsafe_arena_release_signature() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.SignedProposal.signature)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return signature_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void SignedProposal::unsafe_arena_set_allocated_signature(
    std::string* signature) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (signature != nullptr) {
  ...
  signature_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      signature, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.SignedProposal.signature)
}
...
inline std::string* Proposal::unsafe_arena_release_header() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.Proposal.header)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return header_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Proposal::unsafe_arena_set_allocated_header(
    std::string* header) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (header != nullptr) {
  ...
  header_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      header, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.Proposal.header)
}
...
inline std::string* Proposal::unsafe_arena_release_payload() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.Proposal.payload)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return payload_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Proposal::unsafe_arena_set_allocated_payload(
    std::string* payload) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (payload != nullptr) {
  ...
  payload_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      payload, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.Proposal.payload)
}
...
inline std::string* Proposal::unsafe_arena_release_extension() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.Proposal.extension)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return extension_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Proposal::unsafe_arena_set_allocated_extension(
    std::string* extension) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (extension != nullptr) {
  ...
  extension_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      extension, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.Proposal.extension)
}
...
inline void ChaincodeHeaderExtension::_internal_set_payload_visibility(const std::string& value) {
  ...
  payload_visibility_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void ChaincodeHeaderExtension::set_payload_visibility(const char* value) {
  ...
  payload_visibility_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ChaincodeHeaderExtension::set_payload_visibility(const void* value,
  ...
  payload_visibility_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ChaincodeHeaderExtension::_internal_mutable_payload_visibility() {
  ...
  return payload_visibility_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* ChaincodeHeaderExtension::unsafe_arena_release_payload_visibility() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.ChaincodeHeaderExtension.payload_visibility)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return payload_visibility_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ChaincodeHeaderExtension::unsafe_arena_set_allocated_payload_visibility(
    std::string* payload_visibility) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (payload_visibility != nullptr) {
  ...
  payload_visibility_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      payload_visibility, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.ChaincodeHeaderExtension.payload_visibility)
}
...
inline std::string* ChaincodeProposalPayload::unsafe_arena_release_input() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.ChaincodeProposalPayload.input)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return input_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ChaincodeProposalPayload::unsafe_arena_set_allocated_input(
    std::string* input) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (input != nullptr) {
  ...
  input_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      input, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.ChaincodeProposalPayload.input)
}
...
inline std::string* ChaincodeAction::unsafe_arena_release_results() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.ChaincodeAction.results)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return results_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ChaincodeAction::unsafe_arena_set_allocated_results(
    std::string* results) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (results != nullptr) {
  ...
  results_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      results, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.ChaincodeAction.results)
}
...
inline std::string* ChaincodeAction::unsafe_arena_release_events() {
  // @@protoc_insertion_point(field_unsafe_arena_release:protos.ChaincodeAction.events)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return events_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ChaincodeAction::unsafe_arena_set_allocated_events(
    std::string* events) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (events != nullptr) {
  ...
  events_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      events, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:protos.ChaincodeAction.events)
}
...
inline ::protos::TokenExpectation* ChaincodeAction::release_token_expectation() {
  auto temp = unsafe_arena_release_token_expectation();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
