...
inline void ProposalResponsePayload::_internal_set_proposal_hash(const std::string& value) {
  ...
  proposal_hash_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ProposalResponsePayload::set_proposal_hash(const char* value) {
  ...
  proposal_hash_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
...
inline void ProposalResponsePayload::set_proposal_hash(const void* value,
  ...
  proposal_hash_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ProposalResponsePayload::_internal_mutable_proposal_hash() {
  ...
  return proposal_hash_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void Endorsement::_internal_set_endorser(const std::string& value) {
  ...
  endorser_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void Endorsement::set_endorser(const char* value) {
  ...
  endorser_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:protos.Endorsement.endorser)
}
inline void Endorsement::set_endorser(const void* value,
    size_t size) {
  
  endorser_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* Endorsement::_internal_mutable_endorser() {
  ...
  return endorser_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
